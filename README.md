...
| **P7** osint | Tranco; GitHub code search **+ commit-emails**; **AlienVault OTX** threat-pulses + passive-DNS; LeakIX; **LeakCheck** breach-check (free/keyless, per discovered email); SpiderFoot passive | mixed |
